...
<head>
    ...
    <title>Eliminar Funciones</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Papel</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR PAPEL</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">NOMBRE PAPEL </th>
                                            <th>OBRA</th>
                                            <th>DURACION</th>
                                            <th>ATREZO</th>  
                                            <th>ELIMINAR</th>  
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php  echo $row['nombre_papel']?></td>
                                                <td><?php  echo $row['obra']?></td>
                                                <td><?php  echo $row['duracion']?></td>
                                                <td><?php  echo $row['atrezo']?></td>          
                                                <td><a href="eliminar_papel.php?id=<?php echo $row['nombre_papel'] ?>" class="btn btn-danger">Eliminar</a></th>
