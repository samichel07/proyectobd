                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR OBRA</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">TITULO DE OBRA </th>
                                            <th>AUTOR</th>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php  echo $row['titulo_obra']?></td>
                                                <td><?php  echo $row['autor']?></td>
                                                <td><?php  echo $row['anio_publicacion']?></td>
                                                <td><?php  echo $row['representaciones']?></td>          
                                                <td><a href="eliminar_obra.php?id=<?php echo $row['titulo_obra'] ?>" class="btn btn-danger">Eliminar</a></th>
