                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Teatro</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR TEATRO</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">NOMBRE_TEATRO </th>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php  echo $row['nombre_teatro']?></td>
                                                ...
                                                <td><a href="eliminar_teatro.php?nombre_teatro=<?php echo $row['nombre_teatro'] ?>" class="btn btn-danger">Eliminar</a></th>	                
                                        <?php 
                                            } }
                                        ?>
                                    </tbody>
