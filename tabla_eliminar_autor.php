                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Autor</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR AUTOR</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">NOMBRE_ARTISTICO </th>
                                            <th>NOMBRE</th>
                                            <th>APELLIDOS</th>
                                            <th>EDAD</th>  
                                            <th>PRECIO POR LIBRETO</th>
                                            <th>PRECIO POR REPRESENTACIÓN</th>
                                            <th>ELIMINAR</th>  
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php  echo $row['precio_libreto']?></td> 
                                                <td><?php  echo $row['precio_representacion']?></td>          
                                                <td><a href="eliminar_autor.php?nombre_artistico=<?php echo $row['nombre_artistico'] ?>" class="btn btn-danger">Eliminar</a></th>	                
                                        <?php 
                                            } }
                                        ?>
                                    </tbody>
